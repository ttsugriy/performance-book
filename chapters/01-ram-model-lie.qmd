---
title: "The Lie of the RAM Model"
subtitle: "Why Everything You Learned About Memory Is Wrong"
---

::: {.chapter-opener}
In 1950, John von Neumann described a computer architecture where memory is uniform. Every address takes the same time to access. Every byte is equally close to the processor. The Random Access Machine (RAM) model was born.

Seventy years later, we still teach it. And we still pretend it's true.
...
[**Next: The Tyranny of Bandwidth →**](02-bandwidth-tyranny.qmd)
