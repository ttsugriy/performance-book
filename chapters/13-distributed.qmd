...
MLTCP [@rajasekaran2024mltcp] augments standard congestion control with a simple insight: scale congestion windows based on bytes sent per training iteration, not per-flow fairness.
