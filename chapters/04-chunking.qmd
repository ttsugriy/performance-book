...
For most purposes in this book, we treat floating-point operations as associative. See the [Numerical Precision appendix](22-numerical-precision.qmd) for when this breaks down.
:::
...
(a) If d = 64 and we use FP16, what's the maximum tile size B_c for K and V tiles (each B_c × d)?
(b) What happens to HBM traffic if you halve the tile size?
(c) Why not just use the largest possible tile?
