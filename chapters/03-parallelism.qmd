...
6. **Hidden variables abound**: Parallelism introduces hidden variables—NUMA effects, cache contention, scheduler interference—that your mental model may not include. When scaling disappoints, use differential diagnosis (Chapter 16) to isolate which hidden variable is limiting you
