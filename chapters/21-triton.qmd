...
5. **Profile before claiming victory**: Verify performance with Nsight.

6. **Don't replace optimized libraries**: cuBLAS and cuDNN are still king for basic ops.

7. **Start simple**: Vector ops → softmax → layer norm → attention.
...
- OpenAI Triton blog: https://openai.com/blog/triton/
- Triton tutorials: https://triton-lang.org/main/getting-started/tutorials/
- FlashAttention repo (Triton implementation): https://github.com/Dao-AILab/flash-attention
