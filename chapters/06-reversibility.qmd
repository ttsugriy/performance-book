...
Error grows roughly linearly with depth for float32 (~1e-7 per layer), but can grow super-linearly for float16 due to catastrophic cancellation in subtraction.
