...
We introduced the roofline model in @sec-bandwidth-tyranny. It tells us the maximum achievable performance for any operation based on its arithmetic intensity:
