...
The next chapter (@sec-bandwidth) introduces the roofline model. It tells us the maximum achievable performance for any operation based on its arithmetic intensity:
