...
```
FA1: Legacy systems, non-NVIDIA hardware
FA2: A100 and earlier, production stability
FA3: H100/H200, maximum performance

Decision tree:
├── Hardware = Hopper (H100/H200)?
│   ├── Yes → FA3
│   │         ├── Need FP16 accuracy? → FA3 FP16
│   │         └── Can tolerate FP8? → FA3 FP8 (2× faster)
│   └── No → FA2
│             ├── Hardware = Ampere (A100)? → FA2
│             └── Older? → FA1 or PyTorch SDPA
```
