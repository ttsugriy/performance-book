...
╔═══════════════════════════════════════════════════════════════════════╗
║  TIER 1: ALGEBRAIC PROPERTIES                                       ║
║  Properties of the OPERATIONS — guarantee correctness of transforms ║
╠═════════════════════════════╦═══════════════════════════════════════╣
║                             ║                                       ║
║  ASSOCIATIVITY              ║  SEPARABILITY                        ║
║  (a ⊕ b) ⊕ c = a ⊕ (b ⊕ c)  ║  A = UV^T (low-rank decomposition)   ║
║                             ║                                       ║
║  Enables:                   ║  Enables:                             ║
║  • Chunking / streaming     ║  • Factorization                     ║
║  • Parallelization          ║  • Low-rank approximation            ║
║  • Reduction trees          ║  • Decomposition                     ║
║                             ║                                       ║
║  You can PROVE the          ║  You can PROVE the factored           ║
║  reordered result equals    ║  computation equals the original      ║
║  the original               ║                                       ║
║                             ║                                       ║
║  FlashAttention, prefix     ║  LoRA, depthwise separable conv,     ║
║  scan, online softmax       ║  SVD compression                     ║
╠═════════════════════════════╩═══════════════════════════════════════╣
║  TIER 2: STRUCTURAL PROPERTIES                                      ║
║  Properties of the DATA/PROBLEM — enable empirical exploitation     ║
╠════════════════╦════════════════╦════════════════╦═══════════════════╣
║                ║                ║                ║                   ║
║  SPARSITY      ║  REDUNDANCY    ║  LOCALITY      ║  SYMMETRY        ║
║  Most values   ║  Info content  ║  Dependencies  ║  Invariance      ║
║  are zero      ║  < repr. size  ║  are local     ║  under transform ║
║                ║                ║                ║                   ║
║  Skip work     ║  Compress      ║  Tile/block    ║  Share params    ║
║  MoE, pruning  ║  Quantization  ║  Cache reuse   ║  CNNs, Fourier   ║
║                ║  KV cache      ║  Matmul tiling ║  Group equiv.    ║
╚════════════════╩════════════════╩════════════════╩═══════════════════╝

REVERSIBILITY (bonus): Invertible computations enable memory savings
via recomputation. Complements the six properties above.
```

The two tiers reflect a fundamental distinction:

- **Tier 1 (Algebraic)** properties are about the *operations*: you can look at a mathematical expression and determine whether it has them. When present, they **guarantee** that a transformation preserves correctness. Associativity means you *can* reorder; separability means you *can* factorize.

- **Tier 2 (Structural)** properties are about the *data or problem*: they describe the shape of the input, the access pattern, or the problem's symmetries. They **enable** exploitation but require empirical validation — quantizing to INT4 *usually* works because weights are redundant, but you must measure quality to confirm.
...
**Part V (Method):** The process of recognizing and applying properties in practice.
