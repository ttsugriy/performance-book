...
In MoE, the activation pattern is sparse: only k of N experts activate for each token. This isn't an approximation—it's the architecture itself. By designing for sparsity, MoE achieves massive capacity with constant compute.
