...
For a comprehensive treatment of `torch.compile`—including graph breaks, compilation modes, dynamic shapes, and integration patterns—see the [torch.compile Deep Dive](29-torch-compile.qmd).
