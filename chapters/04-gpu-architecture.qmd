...
- 1,600-2,000 GB/s memory bandwidth (A100 SXM 40-80GB; PCIe lower)

A modern CPU (Intel Xeon Platinum) delivers:
- ~2 TFLOPS (FP32)
- ~200 GB/s memory bandwidth

**The GPU can be up to ~100× faster for dense linear algebra (depending on dtype, shape, and batch size).**
