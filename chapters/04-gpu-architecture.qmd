...
**Memory Hierarchy**: GPU memory hierarchy is even steeper than CPU.

**Bandwidth**: HBM bandwidth is the primary constraint for most ML kernels.

**Locality**: Tiling with shared memory is locality optimization for GPUs.

**FlashAttention**: Uses shared memory tiling to stay within GPU SRAM.

**Profiling**: Nsight tools reveal GPU-specific bottlenecks.
