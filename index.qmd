...
::: {.callout-note}
## Note for PDF Readers

This PDF is optimized for offline reading. The web version at [ttsugriy.github.io/performance-book](https://ttsugriy.github.io/performance-book/) includes interactive visualizations and executable notebooks that cannot be reproduced in print. For the full experience, visit the web version.
:::
:::
...
Prefer offline reading? [Download the PDF version](The-Algebra-of-Speed.pdf) of this book.
:::
:::
