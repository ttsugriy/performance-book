...
The first chapter starts with a fundamental truth about modern hardware—one that most algorithms courses gloss over, one that shapes what "fast" actually means in practice.

The truth is that memory has hierarchy, and that hierarchy changes everything.

Let's investigate.

[**Chapter 1: The Memory Hierarchy →**](chapters/01-memory-hierarchy.qmd)
