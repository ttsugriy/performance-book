...
[The Algebraic Framework](chapters/00-algebraic-framework.qmd) -> [The Memory Hierarchy](chapters/01-memory-hierarchy.qmd) -> [Thinking in Bandwidth](chapters/02-bandwidth.qmd) -> [When Parallelism Pays](chapters/03-parallelism.qmd) -> [GPU Architecture and Programming Model](chapters/04-gpu-architecture.qmd) -> [Associativity](chapters/04-chunking.qmd) -> [Separability](chapters/05-factoring.qmd) -> [Sparsity](chapters/06-skipping.qmd) -> [Reversibility](chapters/06-reversibility.qmd) -> [Locality](chapters/07-locality.qmd) -> [Redundancy](chapters/p2-redundancy.qmd) -> [Symmetry](chapters/p2-symmetry.qmd) -> [Investigation: FlashAttention](chapters/10-flash-attention.qmd) -> [Investigation: LoRA](chapters/11-lora.qmd) -> [State-Space Models](chapters/28-state-space-models.qmd)
...
[The Algebraic Framework](chapters/00-algebraic-framework.qmd) (skim) -> [The Memory Hierarchy](chapters/01-memory-hierarchy.qmd) -> [GPU Architecture and Programming Model](chapters/04-gpu-architecture.qmd) -> [Inference Optimization](chapters/14-inference.qmd) -> [Advanced LLM Serving](chapters/27-advanced-serving.qmd) -> [Mastering GPU Memory](chapters/26-gpu-memory.qmd) -> [Investigation: Quantization](chapters/12-quantization.qmd) -> [Profiling Tools: From Novice to Expert](chapters/19-profiling-tools.qmd) -> [torch.compile Deep Dive](chapters/29-torch-compile.qmd)
...
[GPU Architecture and Programming Model](chapters/04-gpu-architecture.qmd) -> [Investigation: Matrix Multiply](chapters/09-matrix-multiply.qmd) -> [Investigation: FlashAttention](chapters/10-flash-attention.qmd) -> [Writing Fast Kernels with Triton](chapters/21-triton.qmd) -> [Modern GPU Kernel Frameworks](chapters/31-gpu-kernel-frameworks.qmd) -> [Profiling Tools: From Novice to Expert](chapters/19-profiling-tools.qmd)
...
|-------|---------------|------------|
| FlashAttention | [The Algebraic Framework](chapters/00-algebraic-framework.qmd), [The Memory Hierarchy](chapters/01-memory-hierarchy.qmd) | [Investigation: FlashAttention](chapters/10-flash-attention.qmd) |
| LoRA | [The Algebraic Framework](chapters/00-algebraic-framework.qmd), [Separability](chapters/05-factoring.qmd) | [Investigation: LoRA](chapters/11-lora.qmd) |
| Quantization | [The Memory Hierarchy](chapters/01-memory-hierarchy.qmd), [Thinking in Bandwidth](chapters/02-bandwidth.qmd) | [Investigation: Quantization](chapters/12-quantization.qmd) |
| Distributed Training | [When Parallelism Pays](chapters/03-parallelism.qmd), [GPU Architecture and Programming Model](chapters/04-gpu-architecture.qmd) | [Distributed Training](chapters/13-distributed.qmd) |
| LLM Serving | [Inference Optimization](chapters/14-inference.qmd), [Mastering GPU Memory](chapters/26-gpu-memory.qmd) | [Advanced LLM Serving](chapters/27-advanced-serving.qmd) |
| MoE | [Sparsity](chapters/06-skipping.qmd), [Distributed Training](chapters/13-distributed.qmd) | [Mixture of Experts](chapters/24-mixture-of-experts.qmd) |
...
[**Thinking in Arrays →**](chapters/00a-thinking-in-arrays.qmd)
...
⚡ **The Algebra of Speed** *(You are here)*
...
🌐 **[Distributed Training from First Principles](https://ttsugriy.github.io/distributed-training-book/)**
Deep dive into distributed training—data parallelism, tensor parallelism, pipeline parallelism, and beyond. The natural continuation of this book's distributed chapter.
